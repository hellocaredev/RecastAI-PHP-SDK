...
class Request
{
    ...
    public function analyseText($text, $options = [])
    {
        ...
        try {
            $response = $client->request('POST', Constants::REQUEST_ENDPOINT, [
                'headers' => $headers,
                'body' => $body
            ]);
        } catch (\Exception $e) {
    ...
    public function converseText($text, $options = [])
    {
        ...
        try {
            $response = $client->request('POST', Constants::CONVERSE_ENDPOINT, [
                'headers' => $headers,
                'body' => $body
            ]);
        } catch (\Exception $e) {
        ...
        return new Conversation($token, $responseBody);
    }
}
